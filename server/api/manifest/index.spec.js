...
var manifestCtrlStub = {
  ...
  upsert: 'manifestCtrl.upsert',
  patch: 'manifestCtrl.patch',
...
describe('Manifest API Router:', function() {
  ...
  describe('PUT /api/manifests/:id', function() {
    it('should route to manifest.controller.upsert', function() {
      expect(routerStub.put
        .withArgs('/:id', 'manifestCtrl.upsert')
        ).to.have.been.calledOnce;
    });
  });

  describe('PATCH /api/manifests/:id', function() {
    it('should route to manifest.controller.patch', function() {
      expect(routerStub.patch
        .withArgs('/:id', 'manifestCtrl.patch')
        ).to.have.been.calledOnce;
    });
  });
